...
import static mods.baritone.api.api.java.baritone.api.command.IBaritoneChatControl.FORCE_COMMAND_PREFIX;
import static mods.baritone.api.api.java.baritone.api.utils.SettingsUtil.*;
