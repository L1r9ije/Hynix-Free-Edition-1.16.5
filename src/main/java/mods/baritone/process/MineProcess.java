...
import mods.baritone.api.api.java.baritone.api.utils.*;
...
import static mods.baritone.api.api.java.baritone.api.pathing.movement.ActionCosts.COST_INF;
...
public final class MineProcess extends BaritoneProcessHelper implements IMineProcess {
    ...
    public void onProtectedBlockMessage() {
        blacklist.addAll(knownOreLocations);
        knownOreLocations.clear();

        BlockPos current = ctx.playerFeet();
        int runDistance = 20;
        branchPoint = current;
        branchPointRunaway = new GoalRunAway(runDistance, current.getY(), current);
    }
