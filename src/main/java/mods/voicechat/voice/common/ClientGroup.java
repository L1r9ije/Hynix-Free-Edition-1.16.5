...
public class ClientGroup {
    ...
    private final mods.voicechat.api.Group.Type type;

    public ClientGroup(UUID id, String name, boolean hasPassword, boolean persistent, boolean hidden, mods.voicechat.api.Group.Type type) {
        this.id = id;
        this.name = name;
