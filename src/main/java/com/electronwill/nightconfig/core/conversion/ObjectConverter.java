...
public final class ObjectConverter {
    ...
    /**
     * Converts an Object to a ClientConfig.
     *
     * @param o           the object to convert
     * @param destination the ClientConfig where to put the values into
    ...
    /**
     * Converts static fields to a ClientConfig.
     *
     * @param clazz       class
     ...
     *
     * @param o                   the object to convert
     * @param destinationSupplier a Supplier that provides the ClientConfig where to put the values into
     * @param <C>                 the destination's type
     * @return the ClientConfig obtained from the Supplier
    ...
    /**
     * Converts a ClientConfig to an Object.
     *
    ...
    /**
     * Converts an Object to a ClientConfig. The {@link #bypassTransient} setting applies.
     */
    ...
    /**
     * Converts a ClientConfig to an Object. The {@link #bypassTransient} and {@link #bypassFinal}
     * settings apply.
     */
