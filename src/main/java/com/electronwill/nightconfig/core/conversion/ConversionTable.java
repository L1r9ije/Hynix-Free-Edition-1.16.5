...
public final class ConversionTable implements Cloneable {
    ...
    /**
     * Performs a shallow in-place conversion of a ClientConfig. Each first-level value of the config
    ...
    /**
     * Performs a deep in-place conversion of a ClientConfig. Each simple (ie non-ClientConfig) value of the
    ...
    /**
     * Returns an ClientConfig that converts "just-in-time" the values that are read from the specified
     * ClientConfig.
     *
     * @param config the config to wrap
    ...
    /**
     * Returns an ClientConfig that converts "just-in-time" the values that are put into the specified
     * ClientConfig.
     *
     * @param config                    the config to wrap
