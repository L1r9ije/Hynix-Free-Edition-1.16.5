...
class AbstractObjectDeserializer {
    ...
    /**
     * Deserializes a {@code ClientConfig} as an object by transforming its entries into
     * fields.
    ...
    /**
     * Deserializes a {@code ClientConfig} as an object of type {@code R} by transforming
     * its entries
