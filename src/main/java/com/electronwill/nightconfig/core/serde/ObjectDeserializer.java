 ...
 * <pre><code>
 * ClientConfig conf = ClientConfig.inMemory();
 * conf.set("x", 12);
 * conf.set("y", -20);
 * conf.set("z", 42);
 * </code></pre>
 * <p>
 * You can deserialize the ClientConfig to an instance of Position with:
 * <pre><code>
...
public final class ObjectDeserializer extends AbstractObjectDeserializer {
    ...
    /**
     * Deserializes a {@code ClientConfig} as an object by transforming the config entries into fields.
    ...
    /**
     * Deserializes a {@code ClientConfig} as an object of type {@code R} by transforming the config entries
