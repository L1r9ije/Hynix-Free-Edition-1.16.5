 ...
 * </code></pre>
 * <p>
 * You can serialize your instance of Position to a ClientConfig with:
 * <pre><code>
 * ClientConfig conf = new ObjectSerializer.standard().serializeFields(pos, ClientConfig::inMemory);
...
public final class ObjectSerializer {
    ...
    static SerdeException noSerializerFound(Object value, Class<?> valueClass,
        ...
        String supportedStr;
        if (format == null) {
            supportedStr = "The current SerializerContext has no ConfigFormat. Is there a bug in the implementation of the chosen ClientConfig type?";
     ...
     * The resulting object can be a ClientConfig, a List, or a plain value that would be
    ...
    /**
     * Serializes an object as a {@code ClientConfig} or type {@code C} by transforming
    ...
    /**
     * Serializes an object as a {@code ClientConfig} by transforming its fields into
