...
/**
 * An abstract ClientConfig that uses a {@link java.util.Map} to store its values. In practice it's
...
public abstract class AbstractConfig implements Config, Cloneable {
     ...
     *
     * @return a new ClientConfig that contains the same entries as this config.
     */
    @Override
