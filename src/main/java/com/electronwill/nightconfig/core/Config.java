...
public interface Config extends UnmodifiableConfig {
    ...
    /**
     * Creates a ClientConfig of the given format.
     *
    ...
    /**
     * Creates a ClientConfig backed by a certain kind of map, given by a supplier.
     * <p>
    ...
    /**
     * Creates a thread-safe ClientConfig of the given format.
     *
     * @param format the config's format
    ...
    /**
     * Creates a ClientConfig with format {@link InMemoryFormat#defaultInstance()}.
     *
     * @return a new empty config
     */
    ...
    /**
     * Creates a ClientConfig with format {@link InMemoryFormat#withUniversalSupport()}.
     *
     * @return a new empty config
     */
    ...
    /**
     * Creates a thread-safe ClientConfig with format {@link InMemoryFormat#defaultInstance()}.
     *
     * @return a new empty config
    ...
    /**
     * Creates a thread-safe ClientConfig with format {@link InMemoryFormat#withUniversalSupport()}.
     *
     * @return a new empty config
     * @deprecated A concurrent HashMap is not enough to make the whole configuration robust to multi-threaded
     * use. Prefer to use a {@link com.electronwill.nightconfig.core.concurrent.ConcurrentConfig}
    ...
    /**
     * Creates a ClientConfig backed by a Map. Any change to the map is reflected in the config and
     * vice-versa.
     * <p>
     * If you wish all your configs to preserve insertion order, please have a look at the more
     * practical setting {@link #setInsertionOrderPreserved(boolean)}.
    ...
    /**
     * Creates a new ClientConfig with the content of the given config. The returned config will have
    ...
    /**
     * Creates a new ClientConfig with the content of the given config.
     *
     * @param config the config to copy
     * @param format the config's format
     * @return a copy of the config
     ...
     * <p>
     * This setting does not apply to configurations created from a Map, from another ClientConfig,
