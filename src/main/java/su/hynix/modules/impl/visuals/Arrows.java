...
public class Arrows extends Module {
    private static final float ARROW_SIZE = 46;
    ...
    public Arrows() {
        ...
        addSettings(rendering, playerColor, friendColor, itemColor, onlyIfNotVisible, radius);
    }
    ...
    private void onRender(EventRender2D eventRender2D) {
        ...
        for (Entity entity : mc.world.getAllEntities()) {
            ...
            if (isValidRotation(rotationX, rotationY, adjustedRadius)) {
                ...
                RenderUtil.drawImage2D(new ResourceLocation("hynix/icons/world_render/triangle.png"), -ARROW_SIZE / 2, -ARROW_SIZE / 2, ARROW_SIZE, ARROW_SIZE, selectedColor);
                GL11.glPopMatrix();
            }
        }
    }
