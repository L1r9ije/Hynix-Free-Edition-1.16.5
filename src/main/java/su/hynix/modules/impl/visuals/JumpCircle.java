...
import su.hynix.events.EventJump;
    ...
    private void onRender3D(EventRender3D event) {
        ...
        for (Circle circle : circles) {
            ...
            for (int i = 0; i < 120; i++) {
                ...
                RenderUtil.drawImage3DQuadInternal(new ResourceLocation("hynix/icons/world_render/jump.png"), worldX + cos1 * circleRadius, worldY, worldZ + sin1 * circleRadius, worldX + cos2 * circleRadius, worldY, worldZ + sin2 * circleRadius, worldX + cos2 * innerRadius, worldY, worldZ + sin2 * innerRadius, worldX + cos1 * innerRadius, worldY, worldZ + sin1 * innerRadius, c0, c1, colorInner, colorInner, cos1 * 0.5f + 0.5f, sin1 * 0.5f + 0.5f, cos2 * 0.5f + 0.5f, sin2 * 0.5f + 0.5f, 0.5f, 0.5f, 0.5f, 0.5f);
            }
        }
