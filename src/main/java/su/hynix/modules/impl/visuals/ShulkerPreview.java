...
public class ShulkerPreview extends Module {
    ...
    public static void showPreview(MatrixStack matrixStack, ItemStack stack, int mouseX, int mouseY) {
        ...
        RenderUtil.drawImage2D(new ResourceLocation("hynix/icons/shulker_view/shulker_box_tooltip.png"), x - 4, y + k + 5, 256, 256, tint);
    ...
    public void onRender2DWorld(EventRender2D e) {
        if (world.get()) {
            ...
            for (ItemEntity itemEnt : shulkerDrops) {
                ...
                RenderUtil.drawImage2D(new ResourceLocation("hynix/icons/shulker_view/shulker_box_tooltip.png"), panelX, panelY, 129, 129, tint);
