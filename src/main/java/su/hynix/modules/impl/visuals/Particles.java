...
public class Particles extends Module {
    private final ModeSetting type = new ModeSetting("Режим", "Звездочки", "Сердечки", "Снежинки", "Доллары", "Звездочки", "Тыковки", "Бубенцы");
    ...
    public void onEvent(EventRender3D event) {
        ...
        ResourceLocation texture = new ResourceLocation("hynix/icons/world_render/" + getTexturePath(type.get()));
