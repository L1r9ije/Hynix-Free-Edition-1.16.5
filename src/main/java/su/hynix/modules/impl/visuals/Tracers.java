...
public class Tracers extends Module {
    ...
    private final BooleanSetting onlyNetherite = new BooleanSetting("Отображать игроков только в незеритовой броне", false, () -> rendering.is("Игроков"));
    ...
    private boolean isValidEntity(Entity entity) {
        if (entity instanceof LivingEntity living && entity != mc.player) {
            ...
            return TargetUtil.isVillagerTarget(living, rendering) || TargetUtil.isAnimalTarget(living, rendering) || TargetUtil.isMonsterTarget(living, rendering);
        }
        return false;
    }
