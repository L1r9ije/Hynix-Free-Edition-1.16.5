...
public class UseTracker extends Module {
    ...
    public void onThrowPotion(EventPopTotem event) {
        ...
        NotificationManager.addNotification(new ResourceLocation("minecraft", "textures/item/totem_of_undying.png"), message);
    }
