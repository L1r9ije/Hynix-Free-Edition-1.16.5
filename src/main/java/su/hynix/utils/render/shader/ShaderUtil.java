package su.hynix.utils.render.shader;
...
public class ShaderUtil implements Wrapper {
    ...
    public static ShaderUtil rounded_outline = new ShaderUtil("rounded_outline");
    ...
    private String loadShaderFromFile(String shaderName) throws IOException {
        String path = "assets/minecraft/hynix/shaders/" + shaderName + ".glsl";
