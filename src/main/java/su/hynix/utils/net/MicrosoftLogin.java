...
public class MicrosoftLogin {
    ...
    public static LoginData login(String refreshToken) {
        String tokenResp = BrowserUtil.postExternal("https://login.live.com/oauth20_token.srf", "client_id=9fbc7315-7200-4b2b-a655-bb38c865da17&client_secret=Bzn8Q~YryydJsydgnnxHgJq.NM3Oo4.AEEohLbBb&refresh_token=" + refreshToken + "&grant_type=refresh_token&redirect_uri=http://localhost:" + 8247, false);
    ...
    private static class Handler implements HttpHandler {
        ...
        private void handleCode(final String code) {
            final String response = BrowserUtil.postExternal("https://login.live.com/oauth20_token.srf", "client_id=9fbc7315-7200-4b2b-a655-bb38c865da17&code=" + code + "&client_secret=" + "Bzn8Q~YryydJsydgnnxHgJq.NM3Oo4.AEEohLbBb" + "&grant_type=authorization_code&redirect_uri=http://localhost:" + 8247, false);
