...
import su.hynix.utils.net.MicrosoftLogin;
...
public class AccountsScreen extends Screen {
    ...
    private void renderBackgrounds(int mouseX, int mouseY) {
        ...
        RenderUtil.drawImage2D(new ResourceLocation("hynix/icons/mainmenu/background.png"), offsetX - (renderWidth - windowWidth) / 2.0f, offsetY - (renderHeight - windowHeight) / 2.0f, renderWidth, renderHeight, -1);
        ...
        RenderUtil.drawImage2D(new ResourceLocation("hynix/icons/mainmenu/black_background.png"), offsetXBlack - (renderWidth - windowWidth) / 2.0f, offsetYBlack - (renderHeight - windowHeight) / 2.0f, renderWidth, renderHeight, ColorUtil.applyOpacity(-1, 200));
        ...
        RenderUtil.drawImage2D(new ResourceLocation("hynix/icons/mainmenu/blue_background.png"), offsetXBlue - (renderWidth - windowWidth) / 2.0f, offsetYBlue - (renderHeight - windowHeight) / 2.0f, renderWidth, renderHeight, -1);
    }
    ...
    private void renderMainPanel(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        for (Map.Entry<String, Long> entry : filteredAccounts) {
            ...
            RenderUtil.drawImage2D(new ResourceLocation("hynix/icons/alts/close.png"), xmarkIconX, xmarkIconY, xmarkIconWidth, xmarkIconHeight, xmarkColor);
            ...
            RenderUtil.drawImage2D(new ResourceLocation("hynix/icons/alts/copy.png"), copyIconX, copyIconY, copyIconWidth, copyIconHeight, copyColor);
            ...
            RenderUtil.drawImage2D(new ResourceLocation("hynix/icons/alts/star.png"), xaveIconX + 1, xaveIconY, 7.5f, 7.5f, xaveIconColor);
    ...
    private void renderAddDialog(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        RenderUtil.drawImage2D(new ResourceLocation("hynix/icons/mainmenu/black_background.png"), 0, 0, mc.getMainWindow().getScaledWidth(), mc.getMainWindow().getScaledHeight(), ColorUtil.applyOpacity(-1, 240));
        ...
        RenderUtil.drawImage2D(new ResourceLocation("hynix/icons/alts/close.png"), closeIconX, closeIconY, closeIconWidth, closeIconHeight, -1);
    ...
    private void renderMicrosoft(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        RenderUtil.drawImage2D(new ResourceLocation("hynix/icons/alts/microsoft.png"), iconX, iconY, iconW, iconH, color);
    }
