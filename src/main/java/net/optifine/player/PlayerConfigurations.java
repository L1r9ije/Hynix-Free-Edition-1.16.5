...
import su.hynix.modules.impl.visuals.SantaHat;
...
public class PlayerConfigurations {
    ...
    static {
        ...
        ResourceLocation resourcelocation = new ResourceLocation("hynix/icons/hats/santa.png");
    ...
    public static void renderHatItem(BipedModel modelBiped, AbstractClientPlayerEntity player, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, int packedOverlayIn) {
        SantaHat playerHat = hynix.getInstance().getModuleManager().getSantaHat();
