            ...
            if (list.size() > j) {
                for (Supplier<ConfiguredFeature<?, ?>> supplier : list.get(j)) {
                    ...
                    try {
                        ...
                        crashreport1.makeCategory("Feature").addDetail("Id", Registry.FEATURE.getKey(configuredfeature.feature)).addDetail("ClientConfig", configuredfeature.config).addDetail("Description", () ->
                        {
