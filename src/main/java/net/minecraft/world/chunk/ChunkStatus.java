...
public class ChunkStatus {
    ...
    private final String name;    public static final ChunkStatus STRUCTURE_REFERENCES = registerSelective("structure_references", STRUCTURE_STARTS, 8, PRE_FEATURES, ChunkStatus.Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
    ...
    private final int ordinal;    public static final ChunkStatus BIOMES = registerSelective("biomes", STRUCTURE_REFERENCES, 0, PRE_FEATURES, ChunkStatus.Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
        generator.func_242706_a(world.func_241828_r().getRegistry(Registry.BIOME_KEY), loadingChunk);
    });
    private final ChunkStatus parent;    public static final ChunkStatus NOISE = registerSelective("noise", BIOMES, 8, PRE_FEATURES, ChunkStatus.Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
        WorldGenRegion worldgenregion = new WorldGenRegion(world, chunks);
        generator.func_230352_b_(worldgenregion, world.func_241112_a_().func_241464_a_(worldgenregion), loadingChunk);
    });
    private final ChunkStatus.IGenerationWorker generationWorker;    public static final ChunkStatus SURFACE = registerSelective("surface", NOISE, 0, PRE_FEATURES, ChunkStatus.Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
        generator.generateSurface(new WorldGenRegion(world, chunks), loadingChunk);
    });
    private final ChunkStatus.ILoadingWorker loadingWorker;    public static final ChunkStatus CARVERS = registerSelective("carvers", SURFACE, 0, PRE_FEATURES, ChunkStatus.Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
        generator.func_230350_a_(world.getSeed(), world.getBiomeManager(), loadingChunk, GenerationStage.Carving.AIR);
    });
    private final int taskRange;    public static final ChunkStatus LIQUID_CARVERS = registerSelective("liquid_carvers", CARVERS, 0, POST_FEATURES, ChunkStatus.Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
        generator.func_230350_a_(world.getSeed(), world.getBiomeManager(), loadingChunk, GenerationStage.Carving.LIQUID);
    });
    private final ChunkStatus.Type type;    public static final ChunkStatus FEATURES = register("features", LIQUID_CARVERS, 8, POST_FEATURES, ChunkStatus.Type.PROTOCHUNK, (status, world, generator, templateManager, worldLightManager, loadingFunction, chunks, loadingChunk) ->
    {
    ...
    private final EnumSet<Heightmap.Type> heightmaps;    public static final ChunkStatus LIGHT = register("light", FEATURES, 1, POST_FEATURES, ChunkStatus.Type.PROTOCHUNK, (status, world, generator, templateManager, worldLightManager, loadingFunction, chunks, loadingChunk) ->
    {
