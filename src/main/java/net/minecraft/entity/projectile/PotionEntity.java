...
import su.hynix.events.EventThrowPotion;
            ...
            for (LivingEntity livingentity : list) {
                if (livingentity.canBeHitWithPotion()) {
                    ...
                    if (d0 < 16.0D) {
                        ...
                        EventThrowPotion eventThrowPotion = new EventThrowPotion(livingentity, this.getItem(), d1, p_213888_1_);
                        EventManager.call(eventThrowPotion);
                    }
                }
            }
        }
