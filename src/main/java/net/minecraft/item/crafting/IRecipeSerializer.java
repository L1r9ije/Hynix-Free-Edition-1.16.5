...
public interface IRecipeSerializer<T extends IRecipe<?>> {
    ...
    IRecipeSerializer<SmithingRecipe> SMITHING = register("smithing", new SmithingRecipe.Serializer());    IRecipeSerializer<StonecuttingRecipe> STONECUTTING = register("stonecutting", new SingleItemRecipe.Serializer<>(StonecuttingRecipe::new));
