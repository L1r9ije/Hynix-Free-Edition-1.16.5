...
public class ParticleManager implements IFutureReloadListener {
    ...
    public Particle addParticle(IParticleData particleData, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
        if (particleData.getType() == ParticleTypes.SMOKE
                || particleData.getType() == ParticleTypes.LARGE_SMOKE
                || particleData.getType() == ParticleTypes.CAMPFIRE_COSY_SMOKE
                || particleData.getType() == ParticleTypes.CAMPFIRE_SIGNAL_SMOKE) {
            EventNoRender event = new EventNoRender(EventNoRender.NorenderType.smoke);
