...
public class GameSettings {
    ...
    public static KeyBinding KEY_PTT = new KeyBinding("key.push_to_talk", InputMappings.INPUT_INVALID.getKeyCode(), "key.categories.voicechat");
    public static KeyBinding KEY_WHISPER = new KeyBinding("key.whisper", InputMappings.INPUT_INVALID.getKeyCode(), "key.categories.voicechat");
    public static KeyBinding KEY_MUTE = new KeyBinding("key.mute_microphone", InputMappings.INPUT_INVALID.getKeyCode(), "key.categories.voicechat");
    public static KeyBinding KEY_DISABLE = new KeyBinding("key.disable_voice_chat", InputMappings.INPUT_INVALID.getKeyCode(), "key.categories.voicechat");
    public static KeyBinding KEY_HIDE_ICONS = new KeyBinding("key.hide_icons", InputMappings.INPUT_INVALID.getKeyCode(), "key.categories.voicechat");
    public static KeyBinding KEY_VOICE_CHAT = new KeyBinding("key.voice_chat", InputMappings.INPUT_INVALID.getKeyCode(), "key.categories.voicechat");
    public static KeyBinding KEY_VOICE_CHAT_SETTINGS = new KeyBinding("key.voice_chat_settings", InputMappings.INPUT_INVALID.getKeyCode(), "key.categories.voicechat");
    public static KeyBinding KEY_GROUP = new KeyBinding("key.voice_chat_group", InputMappings.INPUT_INVALID.getKeyCode(), "key.categories.voicechat");
    public static KeyBinding KEY_TOGGLE_RECORDING = new KeyBinding("key.voice_chat_toggle_recording", InputMappings.INPUT_INVALID.getKeyCode(), "key.categories.voicechat");
    public static KeyBinding KEY_ADJUST_VOLUMES = new KeyBinding("key.voice_chat_adjust_volumes", InputMappings.INPUT_INVALID.getKeyCode(), "key.categories.voicechat");
    ...
    public KeyBinding[] keyBindings = ArrayUtils.addAll(new KeyBinding[]{
            this.keyBindAttack, this.keyBindUseItem, this.keyBindForward,
            this.keyBindLeft, this.keyBindBack, this.keyBindRight,
            this.keyBindJump, this.keyBindSneak, this.keyBindSprint,
            this.keyBindDrop, this.keyBindInventory, this.keyBindChat,
            this.keyBindPlayerList, this.keyBindPickBlock, this.keyBindCommand,
            this.field_244602_au, this.keyBindScreenshot, this.keyBindTogglePerspective,
            this.keyBindSmoothCamera, this.keyBindFullscreen, this.keyBindSpectatorOutlines,
            this.keyBindSwapHands, this.keyBindSaveToolbar, this.keyBindLoadToolbar, this.keyBindAdvancements,
            this.KEY_PTT, this.KEY_WHISPER, this.KEY_MUTE, this.KEY_DISABLE,
            this.KEY_HIDE_ICONS, this.KEY_VOICE_CHAT, this.KEY_VOICE_CHAT_SETTINGS,
            this.KEY_GROUP, this.KEY_TOGGLE_RECORDING, this.KEY_ADJUST_VOLUMES}, this.keyBindsHotbar);
