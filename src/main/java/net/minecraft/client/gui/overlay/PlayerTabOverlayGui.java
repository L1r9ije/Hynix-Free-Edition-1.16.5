...
import su.hynix.modules.impl.visuals.ExtendedTab;
...
public class PlayerTabOverlayGui extends AbstractGui {
    ...
    public void func_238523_a_(MatrixStack p_238523_1_, int p_238523_2_, Scoreboard p_238523_3_, @Nullable ScoreObjective p_238523_4_) {
        ...
        for (NetworkPlayerInfo info : ENTRY_ORDERING.sortedCopy(clientplaynethandler.getPlayerInfoMap())) {
        ...
        boolean isExtendedTabEnabled = hynix.getInstance().getModuleManager().getModule(ExtendedTab.class).isEnabled();
