                ...
                if (timerDelayDrop.hasTimeElapsed(50)) {
                    ...
                    for (int iaa = 0; iaa < maxDrops; iaa++) {
                        for (Slot slot : container.inventorySlots) {
                            if (slot.getHasStack()) {
                                this.minecraft.playerController.windowClick(this.container.windowId, slot.slotNumber, slot.getStack().getCount() > 1 ? 1 : 0, ClickType.THROW, this.minecraft.player);
                                anyItemToDrop = true;
                                break;
                            }
                        }
