...
public class MultiplayerScreen extends Screen {
    ...
    protected void init() {
        ...
        ProxyServer.proxyMenuButton = new Button(ms.width - 125, 5, 120, 20, new StringTextComponent("Proxy: " + ProxyServer.getLastUsedProxyIp()), (buttonWidget) -> {
            mc.displayGuiScreen(new GuiProxy(ms));
        });
