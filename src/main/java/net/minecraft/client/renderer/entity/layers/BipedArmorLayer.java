...
import su.hynix.modules.impl.visuals.ArmorDurabilityView;
    ...
    private void func_241739_a_(MatrixStack p_241739_1_, IRenderTypeBuffer p_241739_2_, T p_241739_3_, EquipmentSlotType p_241739_4_, int p_241739_5_, A p_241739_6_) {
        ...
        if (itemstack.getItem() instanceof ArmorItem armoritem) {
            ...
            if (armoritem.getEquipmentSlot() == p_241739_4_) {
                ...
                float[] rgb;
                if (hynix.getInstance().getModuleManager().getModule(ArmorDurabilityView.class).isEnabled()) {
                    rgb = ArmorDurabilityView.getDurabilityColor(durability);
                } else {
                ...
                if (armoritem instanceof IDyeableArmorItem) {
                    ...
                    this.renderModel(p_241739_1_, p_241739_2_, p_241739_5_, flag, p_241739_6_, f * r, f1 * g, f2 * b, this.getArmorResource(p_241739_3_, itemstack, p_241739_4_, null));
                    ...
                    this.renderModel(p_241739_1_, p_241739_2_, p_241739_5_, flag, p_241739_6_, r, g, b, this.getArmorResource(p_241739_3_, itemstack, p_241739_4_, null));
                }
            }
        }
    }
