...
public class Effect {
    ...
    public ResourceLocation getEffectTexture() {
        ResourceLocation registryName = Registry.EFFECTS.getKey(this);
        if (registryName != null) {
            return new ResourceLocation("textures/mob_effect/" + registryName.getPath() + ".png");
        }
        return new ResourceLocation("textures/mob_effect/unknown.png");
    }
}
