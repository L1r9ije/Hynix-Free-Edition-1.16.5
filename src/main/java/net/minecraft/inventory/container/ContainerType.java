...
public class ContainerType<T extends Container> {
    ...
    private final ContainerType.IFactory<T> factory;    public static final ContainerType<ChestContainer> GENERIC_9X2 = register("generic_9x2", ChestContainer::createGeneric9X2);
